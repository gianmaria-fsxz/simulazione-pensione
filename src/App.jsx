...
export default function App() {
  const [p, setP] = useState({
    ...
    taxBond: 20,
    inpsAliquota: 33,
    inpsMontanteIniziale: 80000,
    inpsRivalutazione: 1,
    addizionaliPct: 2,
    speseExtra: [],
    speseIntervalli: [
      { id: 1, startAge: 39, endAge: 50, type: "abs", value: 4000, label: "Figlio 1", linkPac: true, reduzionePct: 100 },
      { id: 2, startAge: 41, endAge: 52, type: "abs", value: 4000, label: "Figlio 2", linkPac: true, reduzionePct: 100 },
    ],
  });
